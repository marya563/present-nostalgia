...
v->text=TTF_OpenFont("avocado.ttf",35);
...
v->image_vie[0]=IMG_Load("hearts03.png") ;
v->image_vie[1]=IMG_Load("hearts02.png") ;
v->image_vie[2]=IMG_Load("hearts01.png") ;
v->image_vie[3]=IMG_Load("hearts00.png") ;
// positions
